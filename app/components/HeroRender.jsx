...
export default function HeroRender({ heroImage }) {
  ...
  return (
    <section
      className="hero-section relative w-full min-h-screen md:min-h-[56vh] lg:min-h-[68vh] text-[#EDEDED]"
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl min-h-0 grid-cols-1 items-center gap-8 px-4 py-8 sm:px-6 md:grid-cols-2 lg:px-8">
        {/* Left: copy */}
        <motion.div
          variants={container}
          initial="hidden"
        ...
        >
          ...
          <motion.div variants={item} className="mt-8">
            <Link href="/modelos" className="hero-cta revamp-cta primary">
              Ver modelos
            </Link>
          </motion.div>
        </motion.div>
        ...
        <div className="group block" aria-hidden="true">
          ...
          >
            <Image
              ...
              className="hero-image object-cover md:object-contain lg:object-cover"
              loading="eager"
              fetchPriority="high"
              priority
