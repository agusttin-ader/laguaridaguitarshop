...
function pickImage(m) {
  ...
  // If this is a local public image, prefer optimized WebP variant (w1024 if available)
  try {
    if (typeof src === 'string' && src.startsWith('/images/')) {
      const parts = src.split('/')
      const name = parts[parts.length - 1]
      const base = name.replace(/\.[^.]+$/, '')
      // point to webp optimized file (generated by scripts/optimize-images.mjs)
      return `/ _optimized/${base}-w1024.webp`.replace('/ _optimized','/_optimized')
    }
