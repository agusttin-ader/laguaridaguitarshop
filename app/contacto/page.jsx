  ...
  return (
    <main className="about-page mx-auto max-w-7xl px-6 py-24 sm:px-8 lg:px-12">
      <header className="mb-12 text-center">
        ...
        <h1 className="sr-only">La Guarida</h1>
      ...
      <section className="prose prose-invert mx-auto lg:max-w-none lg:grid lg:grid-cols-12 lg:gap-12">
        ...
        <div className="lg:col-span-7 bg-gradient-to-b from-[#0b0b0b] to-[#060606] rounded-2xl p-10 shadow-lg">
          ...
          <p className="mt-4 text-white/80">La Guarida nació en el corazón de una ciudad que parecía detenerse durante la pandemia. Lo que comenzó como un pequeño proyecto de compra y venta —mi proyecto personal— se convirtió, paso a paso, en un lugar donde las guitarras encuentran dueño y las voces encuentran su refugio.</p>

          <p className="mt-4 text-white/80">Durante aquellos meses inciertos, la gente vino con historias; me contaban canciones que necesitaban salir. Así, de a poco, La Guarida dejó de ser sólo un negocio y pasó a ser un refugio para la música.</p>
          ...
          <p className="mt-4 text-white/80">Mi compromiso es simple: calidad, transparencia y pasión por la música. Si tenés dudas o simplemente querés pasar a saludar, mi puerta está abierta.</p>

          <div className="mt-8">
            <h3 className="text-lg font-medium text-[#EDEDED]">Contacto rápido</h3>
            <p className="mt-2 text-sm text-white/70">Teléfono: <a href="tel:+541168696491" className="text-[#EDEDED]">+54 11 6869 6491</a></p>
            ...
            <p className="mt-2 text-sm text-white/70">Email: <a href="mailto:info@laguaridaguitarshop.com" className="text-[#D4AF37]">info@laguaridaguitarshop.com</a></p>
          </div>
        </div>
        ...
        <aside className="lg:col-span-5 mt-8 lg:mt-0">
          <div className="rounded-2xl bg-[#0b0b0b] p-8 shadow-lg">
            ...
            <p className="mt-3 text-white/70">Una sala de escucha: probá guitarras con calma y descubrí modelos únicos traídos por nuestro equipo.</p>
